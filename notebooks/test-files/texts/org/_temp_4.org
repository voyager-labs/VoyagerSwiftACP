...
<!-- saved from url=(0109)https://eschulte.github.io/org-scraps/scraps/2012-01-20-name-src_emacs-lisp%7Borg-current-export-file%7D.html -->
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  ...
  <body>
    <pre><span class="org-level-2">** name src_emacs-lisp{org-current-export-file}</span>
