...
<!-- saved from url=(0046)file:///Users/wonsik/Downloads/_temp_.org.html -->
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  ...
  <body>
    <pre><span class="org-level-2">** custom query of user before evaluating code block</span>
<span class="org-special-keyword">   :PROPERTIES:</span>
   <span class="org-special-keyword">:DATE:</span>     <span class="org-property-value">2012-02-08</span>
<span class="org-special-keyword">   :END:</span>
<span class="org-block-begin-line">#+begin_src sh :eval (if (y-or-n-p "Run operation X?") "yes" "no")
</span>  <span class="builtin">echo</span> <span class="string">"Going ahead with operation X!"
