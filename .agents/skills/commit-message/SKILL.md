...
- **Plain Subject**: Subject is a plain summary sentence — no type prefix (feat/fix/chore etc.), no scope, no `:` separator. Imperative mood, capitalize first letter, no trailing period.
