...
1. Layer direction gate
    - Load `layer-and-segment-rules.md` as the canonical FSD layer and segment contract; reject reverse dependencies and invalid placement.
2. Boundary gate
...
9. Dependency client design gate
    ...
    - See `../../../orchestrator/references/11-dependency-client-design.md` for the full rule.
10. Custom URL scheme and callback target gate
