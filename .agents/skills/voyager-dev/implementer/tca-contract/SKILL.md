...
1. Load `references/tca-contract.md` and `references/development-rules.md` before editing; for system observation, callbacks, notifications, or long-lived tasks, also load `references/observation-lifecycle-rule.md` and `references/observation-lifecycle-spec.md`.
