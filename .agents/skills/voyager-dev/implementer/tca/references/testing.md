...
- `../../../rules/30-macos/11-dependency-client-design.md` -- Test client 설계
- `../../verifier/spec-test-authoring/SKILL.md` -- Spec AC test 작성
- `../../verifier/testing/SKILL.md` -- TestStore 실행/분석
