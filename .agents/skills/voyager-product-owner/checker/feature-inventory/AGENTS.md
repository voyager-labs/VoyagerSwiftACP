# feature-inventory-checker AGENTS
...
| 항목                | 위치                                                                                                                | 노트                |
| ------------------- | ------------------------------------------------------------------------------------------------------------------- | ------------------- |
| 스킬 설명/사용법    | `.agents/skills/voyager-product-owner/checker/feature-inventory/SKILL.md`                               | 체크 범위 요약      |
| deterministic 체크  | `.agents/skills/voyager-product-owner/checker/feature-inventory/scripts/check_feature.py`               | stdlib only         |
| polars 검색/조회    | `.agents/skills/voyager-product-owner/checker/feature-inventory/scripts/vfi.py`                         | venv auto-bootstrap |
| 스키마 마이그레이션 | `.agents/skills/voyager-product-owner/checker/feature-inventory/scripts/migrate_inventory_schema_v2.py` | v2 헤더 추가        |
...
python3 .agents/skills/voyager-product-owner/checker/feature-inventory/scripts/vfi.py search "Quick Look" --scope interactions
