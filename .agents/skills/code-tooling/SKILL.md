...
Core policy at `.agents/rules/00-core/02-verification.md` owns the required verification outcome and tier. This matrix owns executor selection; it applies to interactive agents, while repository `mise` tasks remain valid human and CI paths.
