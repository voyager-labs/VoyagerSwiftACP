...
3. Run the scope-required checks from `00-core/02-verification.md`.
...
- Verification outcome matches the classification in `99-agent/07-outcome-classification.md`.
