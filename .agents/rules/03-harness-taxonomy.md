...
- Evaluate harness changes with `.agents/skills/common/internal/compound-review/references/change-evaluation.md` before treating them as adopted improvements.
