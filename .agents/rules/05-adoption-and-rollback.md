...
3. Confirm `07-harness-change-evaluation.md` produced an `adopt` verdict, or that the operator explicitly accepted a documented `defer` with rationale.
...
2. Check other rule files for orphan references to the adopted file.
