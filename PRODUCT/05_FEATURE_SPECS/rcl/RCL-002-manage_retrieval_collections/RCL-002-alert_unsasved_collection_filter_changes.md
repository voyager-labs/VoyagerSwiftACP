...
feature_id: "RCL-002"
status: "배포 완료"
summary: "미저장 필터 변경 사항이 존재하는 경우 페이지를 벗어날 때 경고창을 띄움"
related_region: "-"
menu: "-"
shortcut: "-"
---
...
- 미저장 필터 변경 사항이 존재하는 경우 페이지를 벗어날 때 경고창을 띄움.
...
- Inventory row: `PRODUCT/04_FEATURE_INVENTORY/INTERACTIONS/data.tsv:146`
