---
interaction_id: "SET-002-confiure_initial_page"
interaction_type: "input"
feature: "Configure General Settings"
category_key: "SET"
feature_id: "SET-002"
status: "배포 완료"
summary: "앱 실행 시 처음 열리는 기본 페이지(홈, 디렉토리, 콜렉션 등)를 지정하여, 사용자가 가장 많이 사용하는 작업 맥락에서 바로 시작할 수 있게 설정한다."
...
- 앱 실행 시 처음 열리는 기본 페이지(홈, 디렉토리, 콜렉션 등)를 지정하여, 사용자가 가장 많이 사용하는 작업 맥락에서 바로 시작할 수 있게 설정한다.
...
- [SET-002-toggle_launch_at_startup](SET-002-toggle_launch_at_startup.md)
...
- Inventory row: `PRODUCT/04_FEATURE_INVENTORY/INTERACTIONS/data.tsv:235`
