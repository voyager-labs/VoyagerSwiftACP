...
feature_id: "SET-003"
status: "배포 완료"
summary: "Appearance 탭에서 앱 테마를 Light, Dark, System 중 하나로 변경하고 즉시 적용한다."
...
- 라이트/다크/자동 및 강조색, 폰트 사이즈 등을 편집합니다.
...
- Appearance 탭에서 앱 테마를 Light, Dark, System 중 하나로 변경하고 즉시 적용한다.
