---
interaction_id: "CEP-003-preview_computed_property_result"
...
- [ ] <<AI>> 사용자가 미리보기를 실행할 때, 시스템이 샘플 엔트리 집합에 대해 수식을 평가하면,
      엔트리별 계산 결과를 미리보기 화면에 표시함.
- [ ] <<AI>> 일부 엔트리에서 평가가 실패한 상태일 때, 미리보기 결과가 표시되면, 성공/실패를 구분해
      표시하고 실패 원인을 함께 제공함.
