...
Voyager의 핵심 페르소나(타깃 사용자) 정의 문서 묶음입니다.
...
- 섹션 내 링크는 "파일 위치 기준 상대경로"를 사용합니다.
- 파일명은 외부/내부 링크의 앵커가 되므로 불필요한 변경을 피합니다.

## ANTI-PATTERNS

- 같은 페르소나를 여러 파일로 분산/중복 생성하지 않기
- 파일명 변경으로 링크를 깨뜨리지 않기
