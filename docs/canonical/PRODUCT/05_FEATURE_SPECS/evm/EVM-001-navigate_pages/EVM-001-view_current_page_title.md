---
interaction_id: "EVM-001-view_current_page_title"
interaction_type: "display"
feature: "Navigate Pages"
category_key: "EVM"
feature_id: "EVM-001"
status: "배포 완료"
summary: "현재 Page의 제목을 표시"
related_region: "file_manager_window.content_pane.content_header"
menu: "-"
shortcut: "-"
---

# View Current Page Title
...
- 표시할 Page 상태가 현재 Page 또는 selection에서 계산 가능한 상태다.

## Expected Outcome

- 현재 Page의 제목을 표시.
- 사용자에게 보이는 결과는 `view_current_page_title_applied` 상태로 정리된다.

## State Changes

- Page의 표시 또는 실행 상태를 갱신한다.
- 이 인터랙션은 [evm_contract.toml](../contracts/evm_contract.toml)의 `view_current_page_title_applied` 상태 어휘를 따른다.
...
- [ ] 표시할 Page 상태가 현재 Page 또는 selection에서 계산 가능한 상태다. 사용자가 View Current Page Title을 실행하면, 현재 Page의 제목을 표시 결과가 `view_current_page_title_applied` 상태로 반영되어야 한다.
...
- `evm.view_current_page_title` 이벤트에 성공 여부와 대상 수, 실패 사유를 기록한다.
...
- Inventory row: `PRODUCT/04_FEATURE_INVENTORY/INTERACTIONS/data.tsv:22`
