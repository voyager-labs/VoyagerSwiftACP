...
feature_id: "SET-003"
status: "배포 완료"
summary: "Entries View의 list/grid 텍스트 크기 설정을 변경하고 UserDefaults에 저장한다."
...
- Entries View의 텍스트 크기 설정을 변경하고, 열려 있는 창의 뷰에 즉시 반영.
...
- Entries View의 list/grid 텍스트 크기 설정을 변경하고 UserDefaults에 저장한다.
...
- [SET-003-adjust_icon_size](SET-003-adjust_icon_size.md)
