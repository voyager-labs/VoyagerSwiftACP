---
interaction_id: "SET-002-check_for_updates"
interaction_type: "command"
feature: "Configure General Settings"
category_key: "SET"
feature_id: "SET-002"
status: "배포 완료"
summary: "“업데이트 확인” 버튼을 눌러 최신 버전 메타데이터를 조회하고, 결과에 따라 상태 배지(최신/업데이트 가능/실패)와 마지막 확인 시간을 표시합니다."
...
- “업데이트 확인” 버튼을 눌러 최신 버전 메타데이터를 조회하고, 결과에 따라 상태 배지(최신/업데이트 가능/실패)와 마지막 확인 시간을 표시합니다.
...
- Inventory row: `PRODUCT/04_FEATURE_INVENTORY/INTERACTIONS/data.tsv:233`
