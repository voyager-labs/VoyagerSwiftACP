---
interaction_id: "SET-001-open_settings_window"
interaction_type: "command"
feature: "Control Settings Window"
category_key: "SET"
feature_id: "SET-001"
status: "배포 완료"
summary: "현재 사용 중인 데스크탑에서 Settings Window 창을 열음"
...
- 현재 사용 중인 데스크탑에서 Settings Window 창을 열음.
...
- [SET-001-swtich_setting_tabs](SET-001-swtich_setting_tabs.md)

## Source

- Inventory row: `PRODUCT/04_FEATURE_INVENTORY/INTERACTIONS/data.tsv:227`
