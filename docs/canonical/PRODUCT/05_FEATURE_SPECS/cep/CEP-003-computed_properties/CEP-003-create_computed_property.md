---
interaction_id: "CEP-003-create_computed_property"
...
- [ ] <<AI>> 생성 화면이 열린 상태일 때, 사용자가 유효한 키·라벨·수식을 입력하고 저장하면, 새
      Computed Property 스키마를 생성하고 엔트리에서 계산된 값을 표시함.
- [ ] <<AI>> 수식이 유효하지 않거나 순환 참조인 상태일 때, 사용자가 저장하면, 저장을 차단하고 오류를
      표시함.
