...
struct ContentPaneContextMenu: View {
    ...
    var body: some View {
        ...
        Menu("Sort By") {
            ...
            sortOrderToggle("Ascending", order: VoyagerWidgetsEntryViewLayout.SortOrder.ascending)
            sortOrderToggle("Descending", order: VoyagerWidgetsEntryViewLayout.SortOrder.descending)
        }
    ...
    private func sortOrderToggle(_ title: String, order: VoyagerWidgetsEntryViewLayout.SortOrder) -> some View {
        Toggle(
            title,
            isOn: Binding(
