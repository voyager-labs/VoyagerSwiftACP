...
enum FileManagerContentChromePropsBuilder {
    ...
    static func makeContentOverlayProps(from state: FileManagerWindowState) -> FileManagerContentOverlayProps {
    ...
    private static func makeSpecialDirectoryIconNames(fileManagerClient: FileManagerClient) -> [String: String] {
