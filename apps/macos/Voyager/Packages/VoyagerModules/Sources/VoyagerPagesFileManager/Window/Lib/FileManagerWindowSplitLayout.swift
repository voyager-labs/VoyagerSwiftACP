...
public enum FileManagerWindowSplitLayout {
    ...
    private static func makeSidebarHosting(
        ...
        if #available(macOS 13.3, *) { sidebarHosting.safeAreaRegions = [] }
    ...
    private static func makeMainContainerHosting(
        ...
        if #available(macOS 13.3, *) { mainContainerHosting.safeAreaRegions = [] }
