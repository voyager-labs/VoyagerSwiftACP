...
public enum EntryListColumn: String, CaseIterable, Equatable, Sendable {
    case name
    case application
    case dateAdded
    case dateCreated
    ...
    public static let defaultVisibleColumns: [EntryListColumn] = [
        .name,
        .dateModified,
        .size,
        .kind,
    ...
    public static let requiredColumns: Set<EntryListColumn> = [.name]
    ...
    public var defaultSortAscending: Bool {
        switch self {
        case .dateAdded, .dateCreated, .dateLastOpened, .dateModified:
            false
    ...
    public var sortDescriptorKey: String? {
    ...
    public static func normalizeVisibleColumns(_ columns: [EntryListColumn]) -> [EntryListColumn] {
