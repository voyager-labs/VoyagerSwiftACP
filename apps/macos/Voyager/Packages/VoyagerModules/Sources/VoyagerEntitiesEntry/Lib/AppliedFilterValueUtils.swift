...
public enum AppliedFilterValueUtils {
    public static func stringValues(from value: VoyagerShared.JSONValue?, valueUIKind: String) -> [String]? {
    ...
    public static func stringValue(from value: VoyagerShared.JSONValue, valueUIKind: String) -> String? {
        switch value {
        case let .string(text):
