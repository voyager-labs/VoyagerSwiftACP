...
public struct RegistryClient: Sendable {
    ...
    public init(
        allProperties: @Sendable @escaping () -> [RegistrySnapshot.PropertyEntry],
        labelForKey: @Sendable @escaping (_ key: String) -> String,
        propertyTypeString: @Sendable @escaping (_ key: String) -> String,
        propertyUnitSpec: @Sendable @escaping (_ key: String) -> SystemPropertyUnitSpec?,
        operatorCodes: @Sendable @escaping (_ key: String) -> [String],
        operatorDefinition: @Sendable @escaping (_ code: String) -> OperatorDefinition,
        operatorValueUIKind: @Sendable @escaping (_ code: String, _ typeKey: String) -> String,
        resolvePropertyKey: @Sendable @escaping (_ key: String) -> PropertyKeyResolution,
    ) {
