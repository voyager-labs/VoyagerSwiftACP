...
struct FileManagerLocationsClient: Sendable {
    var loadLocations: @Sendable (EntryLoadingClient) async -> [SidebarItems.LocationItem]
...
extension FileManagerLocationsClient: DependencyKey {
    nonisolated static var liveValue: FileManagerLocationsClient {
    ...
    nonisolated static var testValue: FileManagerLocationsClient {
        FileManagerLocationsClient(
            loadLocations: { _ in [] },
        )
    }

    nonisolated static var previewValue: FileManagerLocationsClient {
        testValue
    }
}
