...
extension EntriesOperationsFeature {
    ...
    func validateDefaultAppSetting(file: Entry) -> FileOpError? {
    ...
    func loadCommonApplications(for files: [Entry]) -> Effect<Action> {
    ...
    func computeCommonApplications(
        files: [Entry],
