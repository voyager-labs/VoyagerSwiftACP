...
let kPackage = Package(
    name: "VoyagerFeaturesAiProviderConnection",
    platforms: [
        .macOS(.v13),
    ],
    products: [
        .library(name: "VoyagerFeaturesAiProviderConnection", targets: ["VoyagerFeaturesAiProviderConnection"]),
    ],
    dependencies: [
    ...
    targets: [
        ...
        .testTarget(
            name: "VoyagerFeaturesAiProviderConnectionTests",
            dependencies: [
                "VoyagerFeaturesAiProviderConnection",
                .product(name: "VoyagerEntitiesAi", package: "Ai"),
                .product(name: "ComposableArchitecture", package: "swift-composable-architecture"),
            ],
        ),
