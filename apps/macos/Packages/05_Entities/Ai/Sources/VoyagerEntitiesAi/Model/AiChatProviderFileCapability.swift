...
public enum AiChatProviderFileCapability {
    ...
    public static let localInlineTextTotalUTF8ByteLimit = Int64(AiChatRequestContextBudget.totalAttachmentTextUTF8ByteBudget)
...
private extension AiChatProviderFileCapability {
    ...
    static let openAIAllowlist: [String: AllowlistEntry] = [
        ...
        "txt": .init(kind: .plainTextDocument, mimeTypes: ["text/plain"], contentTypeIdentifiers: ["public.plain-text"]),
        "md": .init(kind: .plainTextDocument, mimeTypes: ["text/markdown"], contentTypeIdentifiers: ["net.daringfireball.markdown"]),
        "json": .init(kind: .plainTextDocument, mimeTypes: ["application/json", "text/json"], contentTypeIdentifiers: ["public.json"]),
        "xml": .init(kind: .plainTextDocument, mimeTypes: ["application/xml", "text/xml"], contentTypeIdentifiers: ["public.xml"]),
        ...
        "js": .init(kind: .plainTextDocument, mimeTypes: ["text/javascript", "application/javascript"], contentTypeIdentifiers: ["com.netscape.javascript-source"]),
        "ts": .init(kind: .plainTextDocument, mimeTypes: ["text/typescript", "application/typescript"], contentTypeIdentifiers: ["public.typescript-source"]),
        "tsx": .init(kind: .plainTextDocument, mimeTypes: ["text/tsx"], contentTypeIdentifiers: ["public.tsx-source"]),
        "swift": .init(kind: .plainTextDocument, mimeTypes: ["text/x-swift"], contentTypeIdentifiers: ["public.swift-source"]),
        "py": .init(kind: .plainTextDocument, mimeTypes: ["text/x-python"], contentTypeIdentifiers: ["public.python-script"]),
        "rb": .init(kind: .plainTextDocument, mimeTypes: ["text/x-ruby"], contentTypeIdentifiers: ["public.ruby-script"]),
        ...
        "java": .init(kind: .plainTextDocument, mimeTypes: ["text/x-java-source"], contentTypeIdentifiers: ["com.sun.java-source"]),
        "kt": .init(kind: .plainTextDocument, mimeTypes: ["text/x-kotlin"], contentTypeIdentifiers: ["public.kotlin-source"]),
        "c": .init(kind: .plainTextDocument, mimeTypes: ["text/x-c"], contentTypeIdentifiers: ["public.c-source"]),
        "cpp": .init(kind: .plainTextDocument, mimeTypes: ["text/x-c++"], contentTypeIdentifiers: ["public.c-plus-plus-source"]),
        "h": .init(kind: .plainTextDocument, mimeTypes: ["text/x-chdr"], contentTypeIdentifiers: ["public.c-header"]),
        "hpp": .init(kind: .plainTextDocument, mimeTypes: ["text/x-c++hdr"], contentTypeIdentifiers: ["public.c-plus-plus-header"]),
        "yaml": .init(kind: .plainTextDocument, mimeTypes: ["application/x-yaml", "text/yaml"], contentTypeIdentifiers: ["public.yaml"]),
        "yml": .init(kind: .plainTextDocument, mimeTypes: ["application/x-yaml", "text/yaml"], contentTypeIdentifiers: ["public.yaml"]),
        "toml": .init(kind: .plainTextDocument, mimeTypes: ["application/toml"], contentTypeIdentifiers: ["public.toml"]),
        "csv": .init(kind: .plainTextDocument, mimeTypes: ["text/csv"], contentTypeIdentifiers: ["public.comma-separated-values-text"]),
        "doc": .init(kind: .openAIDocument, mimeTypes: ["application/msword"], contentTypeIdentifiers: ["com.microsoft.word.doc"]),
        "docx": .init(kind: .openAIDocument, mimeTypes: ["application/vnd.openxmlformats-officedocument.wordprocessingml.document"], contentTypeIdentifiers: ["org.openxmlformats.wordprocessingml.document"]),
        "rtf": .init(kind: .openAIDocument, mimeTypes: ["application/rtf", "text/rtf"], contentTypeIdentifiers: ["public.rtf"]),
        "odt": .init(kind: .openAIDocument, mimeTypes: ["application/vnd.oasis.opendocument.text"], contentTypeIdentifiers: ["org.oasis-open.opendocument.text"]),
        "ppt": .init(kind: .openAIDocument, mimeTypes: ["application/vnd.ms-powerpoint"], contentTypeIdentifiers: ["com.microsoft.powerpoint.ppt"]),
        "pptx": .init(kind: .openAIDocument, mimeTypes: ["application/vnd.openxmlformats-officedocument.presentationml.presentation"], contentTypeIdentifiers: ["org.openxmlformats.presentationml.presentation"]),
        "xls": .init(kind: .spreadsheet, mimeTypes: ["application/vnd.ms-excel"], contentTypeIdentifiers: ["com.microsoft.excel.xls"]),
        "xlsx": .init(kind: .spreadsheet, mimeTypes: ["application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"], contentTypeIdentifiers: ["org.openxmlformats.spreadsheetml.sheet"]),
        "tsv": .init(kind: .spreadsheet, mimeTypes: ["text/tab-separated-values"], contentTypeIdentifiers: ["public.tab-separated-values-text"]),
    ]
    ...
    static func providerDecision(
        ...
        guard let normalizedExtension else {
            return makeDecision(
        ...
        guard normalizedMIMEType != "application/octet-stream" else {
            return makeDecision(
        ...
        guard entry.mimeTypes.contains(normalizedMIMEType) else {
            return makeDecision(
        ...
        if let normalizedContentTypeIdentifier,
        ...
        return makeDecision(
            disposition: .providerNativeUpload(kind: entry.kind, mimeType: normalizedMIMEType),
            extension: normalizedExtension,
            mimeType: normalizedMIMEType,
            contentTypeIdentifier: normalizedContentTypeIdentifier,
        )
