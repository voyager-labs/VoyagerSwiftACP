...
@ObservableState
struct AiProviderSetupRowState: Equatable, Identifiable {
    var provider: AiProvider
    var connectionState: ProviderConnectionState = .notVerified
    var statusReason: ProviderStatusReason = .none
    var flowState: AiProviderSetupRowFlowState = .idle
    var enteredKey = ""
    ...
    var authMethodLabel: String {
        switch ProviderDescriptor.descriptor(for: provider)?.authMethod {
        case .oauth:
            "OAuth"
        case .apiKey:
            "API Key"
...
enum AiProviderSetupRowFlowState: Equatable {
    case idle
    case connecting
    case disconnecting
...
@CasePathable
enum AiProviderSetupRowAction: CasePathable, Equatable {
...
@Reducer
struct AiProviderSetupRowFeature {
    typealias State = AiProviderSetupRowState
    typealias Action = AiProviderSetupRowAction
