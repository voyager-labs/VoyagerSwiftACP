...
| Spec ID | Interaction ID                         | Owner Test Class                   | Owner Test File                                                                                                          | Evidence Target                                                                                                  | Classification |
| ------- | -------------------------------------- | ---------------------------------- | ------------------------------------------------------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------- | -------------- |
| ONB-002 | `ONB-002-show_access_unlock_status`    | `BetaAccessFeatureTests`           | `apps/macos/Packages/04_Features/BetaAccess/Tests/VoyagerFeaturesBetaAccessTests/BetaAccessFeatureTests.swift`           | `swift test --package-path apps/macos/Packages/04_Features/BetaAccess --filter BetaAccessFeatureTests`           | in-scope       |
| ONB-002 | `ONB-002-apply_access_unlock_result`   | `BetaAccessFeatureTests`           | `apps/macos/Packages/04_Features/BetaAccess/Tests/VoyagerFeaturesBetaAccessTests/BetaAccessFeatureTests.swift`           | `swift test --package-path apps/macos/Packages/04_Features/BetaAccess --filter BetaAccessFeatureTests`           | in-scope       |
| ONB-002 | `ONB-002-start_access_unlock_recovery` | `OnboardingBetaAccessGatewayTests` | `apps/macos/Packages/04_Features/BetaAccess/Tests/VoyagerFeaturesBetaAccessTests/OnboardingBetaAccessGatewayTests.swift` | `swift test --package-path apps/macos/Packages/04_Features/BetaAccess --filter OnboardingBetaAccessFeatureTests` | in-scope       |
