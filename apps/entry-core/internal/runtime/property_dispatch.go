...
type PropertyService interface {
	...
	UpdateDefinitionMetadata(ctx context.Context, workspace domainentry.WorkspaceContext, propertyID domainentry.PropertyID, expectedRevision int, displayName string) (applicationproperty.DefinitionView, error)
	DisableDefinition(ctx context.Context, workspace domainentry.WorkspaceContext, propertyID domainentry.PropertyID, expectedRevision int) (applicationproperty.DefinitionView, error)
	CreateOption(ctx context.Context, workspace domainentry.WorkspaceContext, propertyID domainentry.PropertyID, expectedRevision int, label string) (applicationproperty.DefinitionView, error)
	RenameOption(ctx context.Context, workspace domainentry.WorkspaceContext, propertyID domainentry.PropertyID, optionID domainentry.PropertyOptionID, expectedRevision int, label string) (applicationproperty.DefinitionView, error)
	ReorderOptions(ctx context.Context, workspace domainentry.WorkspaceContext, propertyID domainentry.PropertyID, expectedRevision int, orderedIDs []domainentry.PropertyOptionID) (applicationproperty.DefinitionView, error)
	DisableOption(ctx context.Context, workspace domainentry.WorkspaceContext, propertyID domainentry.PropertyID, optionID domainentry.PropertyOptionID, expectedRevision int) (applicationproperty.DefinitionView, error)
